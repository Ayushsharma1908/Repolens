...
if (process.env.GOOGLE_CLIENT_ID && process.env.GOOGLE_CLIENT_SECRET) {
  ...
  console.warn('Google Client ID/Secret not provided. Google authentication will not be available.');
}
...
if (process.env.GITHUB_CLIENT_ID && process.env.GITHUB_CLIENT_SECRET) {
  ...
  console.warn('GitHub Client ID/Secret not provided. GitHub authentication will not be available.');
}
