...
export default function SignUp() {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        // FIX: pass user and token separately
          ...
          <div className="relative">
            ...
            <div className="relative bg-[#0F1320]/90 backdrop-blur-sm rounded-3xl border border-[#334155] overflow-hidden shadow-2xl shadow-blue-500/10">
              ...
              <div className="px-8 pt-10 pb-4 text-center">
                ...
                <p className="text-[#94A3B8] text-sm">Gain deep insights into your repositories.</p>
              </div>
              ...
              <form onSubmit={handleSignUp} className="px-8 pb-8 space-y-5">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      placeholder="johndoe"
                      className="w-full pl-8 pr-4 py-3.5 bg-[#1E293B] border border-[#334155] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#60A5FA]/50 text-white placeholder-[#64748B] transition"
                    />
                  </div>
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#3B82F6] hover:bg-[#60A5FA] disabled:opacity-50 disabled:cursor-not-allowed text-white py-3.5 rounded-xl font-semibold transition-all shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 mt-4 flex items-center justify-center gap-2"
                >
                  {loading ? (
                    <>
